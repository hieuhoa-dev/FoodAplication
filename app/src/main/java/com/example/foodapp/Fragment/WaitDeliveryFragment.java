...
public class WaitDeliveryFragment extends Fragment {
    ...
    FragmentWaitDeliveryBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentWaitDeliveryBinding.inflate(getLayoutInflater());
        setVariable();
    ...
    void setVariable() {
        ...
        binding.waitDeliveryRV.setLayoutManager(linearLayoutManager);
        binding.waitDeliveryRV.setAdapter(adapter);
        binding.waitDeliveryRV.setVisibility(View.GONE);
        ...
        billListener = billRepository.getBillOnChangeListener(new OnBillListener() {
            ...
            public void onDataReceived(ArrayList<Bill> bills, BillStatus status) {
                if (status == BillStatus.WAIT_DELIVERY) {
                    LocalDateTime now = LocalDateTime.now();
                    DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
                    billList.clear();
                    billList.addAll(bills);
                    adapter.notifyDataSetChanged();
                    binding.waitDeliveryRV.setVisibility(View.VISIBLE);
